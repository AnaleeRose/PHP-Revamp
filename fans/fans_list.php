...
$sql = 'SELECT FanID, Name, Address, Email, dateJoined FROM faninfo ORDER BY dateJoined DESC';
...
<table class='table'>
    ...
    <tr>
        ...
        <td><a href="http://localhost:81/phprevamp/fans/fan_details.php?FanID=<?= $row['FanID']; ?>" class="text-info">DETAILS</a></td>
    </tr>
    <?php } ?>
</table>
<?php } ?>
<p><a href="http://localhost:81/phprevamp/fans/fans_email_list.php" class="btn btn-outline-info">Get Email List</a></p>
